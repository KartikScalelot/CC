				...
				<form onSubmit={formik.handleSubmit}>
					<div className="w-full">
						<div className="w-full flex flex-wrap sm:flex-nowrap items-center sm:mb-7 sm:space-x-6">
							...
							{/* <select type="text" name="card_type" className="input_box2 placeholder:text-[#94A3B8] text-sm sm:placeholder:text-xl" placeholder='Select Card Type' required onChange={(e) => setInputValue("card_type", e.target.value)}>
									<option value="Credit Card">Credit Card</option>
									<option value="Debit Card">Debit Card</option>
								</select> */}

							{/* <input type="text" name="card_type" className="input_box2 placeholder:text-[#94A3B8]text-sm sm: placeholder:text-xl" placeholder='Select card' required onChange={(e) => setInputValue("card_type", e.target.value)} /> */}
						...
						<div className="w-full flex flex-wrap sm:flex-nowrap sm:mb-7 sm:space-x-6">
							<div className='w-full sm:w-1/2 mb-4 sm:mb-0'>
								...
								<input type="text" name="card_bank_name" className="input_box2 placeholder:text-[#94A3B8] text-sm sm:placeholder:text-xl" placeholder='Enter bank name' required onChange={(e) => setInputValue("card_bank_name", e.target.value)} />
							...
							<div className='w-full sm:w-1/2 mb-4 sm:mb-0'>
								...
								<input maxLength={12} type="text" name="card_number" className="input_box2 placeholder:text-[#94A3B8] text-sm sm:placeholder:text-xl" placeholder='Enter card number' required onChange={(e) => setInputValue("card_number", e.target.value)} />
						...
						<div className="w-full flex flex-wrap sm:flex-nowrap sm:mb-7 sm:space-x-6">
							<div className='w-full sm:w-1/2 mb-4 sm:mb-0'>
								...
								<input type="text" name="card_holder_name" className="input_box2 placeholder:text-[#94A3B8] text-sm sm:placeholder:text-xl" placeholder='Enter card holder name' required onChange={(e) => setInputValue("card_holder_name", e.target.value)} />
							...
							<div className='w-full sm:w-1/2 mb-4 sm:mb-0'>
								...
								<input type="text" name="card_network" className="input_box2 placeholder:text-[#94A3B8] text-sm sm:placeholder:text-xl" placeholder='Visa' required onChange={(e) => setInputValue("card_network", e.target.value)} />
						...
						<div className="w-full flex flex-wrap sm:flex-nowrap sm:mb-7 sm:space-x-6">
							...
							{/* <div className='w-full sm:w-1/2 mb-4 sm:mb-0'>
								...
								<label htmlFor="card_exp_date" className="input-title2 relative">Card Expiry Date *</label>
								<input type="date" name="card_exp_date" className="input_box2 placeholder:text-[#94A3B8] text-sm sm:placeholder:text-xl" placeholder='Enter card expiry date' required onChange={(e) => setInputValue("card_exp_date", e.target.value)} />
								<small className="text-red-500 text-xs">{formik.errors.card_exp_date}</small>
						...
						<div className="w-full flex flex-wrap sm:flex-nowrap sm:mb-7 sm:space-x-6">
							<div className='w-full sm:w-1/2 mb-4 sm:mb-0'>
								...
								<input maxLength={3} type="text" name="card_cvv" className="input_box2 placeholder:text-[#94A3B8] text-sm sm:placeholder:text-xl" placeholder='Enter cvv' required onChange={(e) => setInputValue("card_cvv", e.target.value)} />
							...
							{/* {formik.values.card_type === "Debit Card" ?
								<>
									...
									<div className='w-full sm:w-1/2'>
										...
										<input type="number" name="available_balance" className="input_box2 placeholder:text-[#94A3B8] text-sm sm:placeholder:text-xl" placeholder='Enter available balance' required onChange={(e) => setInputValue("available_balance", e.target.value)} />
							...
							<div className='w-full sm:w-1/2'>
								...
								<input type="number" name="credit_amount" className="input_box2 placeholder:text-[#94A3B8] text-sm sm:placeholder:text-xl" placeholder='Enter credit amount' required onChange={(e) => setInputValue("credit_amount", e.target.value)} />
