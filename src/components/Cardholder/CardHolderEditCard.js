                        ...
                        <div className="w-full">
                                ...
                                <div className='w-full md:w-1/2 mb-4 md:mb-0'>
                                    ...
                                    <div className="cardType flex items-center space-x-10 px-4 py-3">
                                        <label className='flex items-center relative' htmlFor='business'>
                                            <input type="radio" name="card_category" id='business' value='business' className="absolute inset-0 z-10 cursor-pointer opacity-0 transactiongroup" defaultChecked={formik.values?.card_category === "business" ? true : false} onChange={(e) => setInputValue("card_category", e.target.value)} defaultValue={formik.values?.card_category || ""} />
                                        ...
                                        <label className='flex items-center relative' htmlFor='personal'>
                                            <input type="radio" name="card_category" id='personal' value='personal' className="absolute inset-0 z-10 cursor-pointer opacity-0 transactiongroup" defaultChecked={formik.values?.card_category === "personal" ? true : false} onChange={(e) => setInputValue("card_category", e.target.value)} defaultValue={formik.values?.card_category || ""} />
                                            <div className='flex items-center'>
                                                <span className="inline-block w-5 h-5 rounded-full border-2 border-black/20 mr-4 radio"></span>
                                            </div>
                            ...
                            <div className="w-full flex flex-wrap md:flex-nowrap md:space-x-6 md:mb-7">
                                <div className='w-full md:w-1/2 mb-4 md:mb-0'>
                                    ...
                                    <input type="text" name="card_bank_name" className="input_box2 placeholder:text-[#94A3B8] placeholder:text-sm md:placeholder:text-xl" placeholder='Enter bank name' onChange={(e) => setInputValue("card_bank_name", e.target.value)} defaultValue={formik.values?.card_bank_name || ""} />
                                ...
                                <div className='w-full md:w-1/2 mb-4 md:mb-0'>
                                    ...
                                    <input type="text" name="card_network" className="input_box2 placeholder:text-[#94A3B8] placeholder:text-sm md:placeholder:text-xl" placeholder='Visa' onChange={(e) => setInputValue("card_network", e.target.value)} defaultValue={formik.values?.card_network || ""} />
                            ...
                            <div className="w-full flex flex-wrap md:flex-nowrap md:space-x-6 md:mb-7">
                                <div className='w-full md:w-1/2 mb-4 md:mb-0'>
                                    ...
                                    <input type="text" name="card_holder_name" className="input_box2 placeholder:text-[#94A3B8] placeholder:text-sm md:placeholder:text-xl" placeholder='Enter card holder name' onChange={(e) => setInputValue("card_holder_name", e.target.value)} defaultValue={formik.values?.card_holder_name || ""} />
                                ...
                                <div className='w-full md:w-1/2 mb-4 md:mb-0'>
                                    ...
                                    <label className='relative'>
                                        {console.log("formik.values?.card_exp_date", formik.values?.card_exp_date)}
                            ...
                            <div className="w-full flex flex-wrap md:flex-nowrap md:space-x-6 md:mb-7">
                                <div className='w-full md:w-1/2 mb-4 md:mb-0'>
                                    ...
                                    <input maxLength={3} type="text" name="card_cvv" className="input_box2 placeholder:text-[#94A3B8] placeholder:text-sm md:placeholder:text-xl" defaultValue={formik.values.card_cvv || ""} placeholder='Enter cvv' onChange={(e) => setInputValue("card_cvv", e.target.value)} />
