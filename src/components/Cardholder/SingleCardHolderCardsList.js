                ...
                <div className="wrapper min-h-full">
                    <div className="sm:flex flex-wrap items-center justify-between">
                        <div className="flex items-center cursor-pointer">
                            ...
                            <h3 className=" text-yankeesBlue leading-8 pl-4 smx:pl-7 truncate">{userData.first_name && userData.last_name ? <>{userData.first_name} {userData.last_name}'s Cards </> : ""}</h3>
                        </div>
